...
DevEco Code is built on top of the open-source project [OpenCode](https://opencode.ai), retaining its terminal UI, configuration system, Provider/MCP/Skill/Plugin capabilities, and extending them with integrations for DevEco Studio, Hvigor, HDC, ArkTS checking, and device debugging for HarmonyOS projects.
