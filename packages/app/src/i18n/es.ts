export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en deveco.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (deveco.json)",
