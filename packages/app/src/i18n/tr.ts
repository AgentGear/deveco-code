...
export const dict = {
  ...
  "dialog.plugins.empty": "Eklentiler deveco.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (deveco.json) sağlayıcı/model adlarını kontrol edin",
