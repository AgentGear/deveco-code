export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans deveco.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (deveco.json) pour les noms de fournisseur/modèle",
