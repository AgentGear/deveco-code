...
export const dict = {
  ...
  "dialog.plugins.empty": "In deveco.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (deveco.json) auf Anbieter-/Modellnamen",
