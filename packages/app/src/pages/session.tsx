...
const USE_NEW_SESSION_DESIGN = import.meta.env.VITE_DEVECO_CHANNEL !== "prod"
...
export default function Page() {
  ...
  const isV2NewSessionPage = () =>
    shouldUseV2NewSessionPage({ channel: import.meta.env.VITE_DEVECO_CHANNEL, sessionID: params.id })
