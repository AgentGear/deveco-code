...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.DEVECO_WEBSEARCH_PROVIDER === "exa" || process.env.DEVECO_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.DEVECO_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("DEVECO_EXPERIMENTAL") || truthy("DEVECO_ENABLE_EXA") || truthy("DEVECO_EXPERIMENTAL_EXA"),
    enableParallel: truthy("DEVECO_ENABLE_PARALLEL") || truthy("DEVECO_EXPERIMENTAL_PARALLEL"),
