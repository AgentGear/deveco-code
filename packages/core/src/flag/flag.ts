...
const DEVECO_DISABLE_CLAUDE_CODE_SKILLS =
  DEVECO_DISABLE_CLAUDE_CODE || truthy("DEVECO_DISABLE_CLAUDE_CODE_SKILLS")
...
export const Flag = {
  ...
  DEVECO_AUTO_SHARE: truthy("DEVECO_AUTO_SHARE"),
  ...
  DEVECO_ENABLE_EXPERIMENTAL_MODELS: truthy("DEVECO_ENABLE_EXPERIMENTAL_MODELS"),
  ...
  DEVECO_EXPERIMENTAL_ICON_DISCOVERY: DEVECO_EXPERIMENTAL || truthy("DEVECO_EXPERIMENTAL_ICON_DISCOVERY"),
  ...
  DEVECO_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS: number("DEVECO_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS"),
  DEVECO_EXPERIMENTAL_OUTPUT_TOKEN_MAX: number("DEVECO_EXPERIMENTAL_OUTPUT_TOKEN_MAX"),
  DEVECO_EXPERIMENTAL_OXFMT: DEVECO_EXPERIMENTAL || truthy("DEVECO_EXPERIMENTAL_OXFMT"),
  DEVECO_EXPERIMENTAL_LSP_TY: truthy("DEVECO_EXPERIMENTAL_LSP_TY"),
  ...
  DEVECO_DISABLE_EMBEDDED_WEB_UI: truthy("DEVECO_DISABLE_EMBEDDED_WEB_UI"),
  DEVECO_DB: process.env["DEVECO_DB"],
  DEVECO_DISABLE_CHANNEL_DB: truthy("DEVECO_DISABLE_CHANNEL_DB"),
