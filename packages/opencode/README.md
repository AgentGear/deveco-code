# @codegenie-ai/codegenie-cli

面向 HarmonyOS（鸿蒙）开发场景的 AI CLI 助手。

[npm 包页面](https://www.npmjs.com/package/@codegenie-ai/codegenie-cli) |
...
> macOS 如果遇到全局安装权限问题，可尝试 `sudo -i npm install -g @codegenie-ai/codegenie-cli --registry=https://registry.npmjs.org`。
