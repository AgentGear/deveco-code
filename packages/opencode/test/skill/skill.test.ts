      ...
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".deveco", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".deveco", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".deveco", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".deveco", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".deveco", "skill", "manual-skill", "SKILL.md"),
              `---
name: manual-skill
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".deveco", "skill", "opencode-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .deveco/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".deveco", "skill", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .deveco/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".deveco", "skills", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .deveco/skills directory.
---
