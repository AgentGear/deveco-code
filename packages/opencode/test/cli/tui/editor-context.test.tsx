...
const originalOpencodePort = process.env.CODEGENIE_EDITOR_SSE_PORT

afterEach(() => {
  process.env.CLAUDE_CODE_SSE_PORT = originalClaudePort
  process.env.CODEGENIE_EDITOR_SSE_PORT = originalOpencodePort
})
...
test("useEditorContext reconnect switches editor server by session directory", async () => {
  ...
  process.env.CODEGENIE_EDITOR_SSE_PORT = undefined
...
test("useEditorContext connects with CODEGENIE_EDITOR_SSE_PORT", async () => {
  await using tmp = await tmpdir()
  process.env.CLAUDE_CODE_SSE_PORT = undefined
  process.env.CODEGENIE_EDITOR_SSE_PORT = "4020"
