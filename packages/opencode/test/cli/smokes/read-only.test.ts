...
describe("opencode read-only commands (smoke)", () => {
  ...
  // DEVECO_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh DEVECO_TEST_HOME means
  ...
  // in production it'd be a path under DEVECO_TEST_HOME / XDG_DATA_HOME.
